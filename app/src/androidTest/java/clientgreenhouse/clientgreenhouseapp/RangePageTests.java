...
public class RangePageTests {
    ...
    public void attemptTests() {
        String emptyRangePhrase = "Input both values for the new range before submitting";
        String invalidRangePhrase = "Make sure your lower bounds do not equal or exceed your upper bounds";
        String acceptedRangePhrase = "Range successfully updated";
        ...
        onView(withId(R.id.tempNewLowVal)).perform(typeText("20.2"));
        ...
        //Attempt to submit value in only lower bound
        onView(withId(R.id.tempNewUpperVal)).perform(typeText("20.2"));
        ...
        onView(withId(R.id.tempNewLowVal)).perform(clearText(), typeText("25.2"));
        ...
        onView(withId(R.id.tempNewLowVal)).perform(clearText(), typeText("15.2"));
